...
**YOU ARE IN: `dendrite/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/dendrite/` (rig root) or other directories
...
**Your mail address:** `dendrite/polecats/obsidian`
**Your rig:** dendrite
**Your Witness:** `dendrite/witness`
...
| Ask Witness for help | `gt mail send dendrite/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`dendrite/witness`) when:
...
```bash
gt mail send dendrite/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
